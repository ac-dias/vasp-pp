...
!gfortran vasp_bands_kpath_fake_sp.f90 -o vbands_k_f_sp.x
! vbands_k_f_sp.x 6 20 >bands.dat
...
program main
	...
	do i=1,nkpoints
		...
		do j=1,nbands
			...
			read(100,*) flag,energies(i,j,2),energies(i,j,3),flag,flag
