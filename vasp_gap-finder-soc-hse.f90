!gfortran vasp_gap-finder-soc-hse.f90 -o gaps_h.x
!gaps_h.x 30 , 30 numero de pontos k
program main
	...
	double precision :: cbmsoc,vbmsoc
	...
	OPEN(UNIT=200, FILE= "gap_vasp_soc.dat",STATUS='unknown', IOSTAT=erro)
...
50	continue		
	...
	do i=1,nkpts
		...
		if (gaux .lt. gapdir) then
			...
			cbmsoc=energy(i,nocp(i)+1,1)-energy(i,nocp(i),1)
			vbmsoc=energy(i,nocp(i)-1,1)-energy(i,nocp(i)-2,1)
		else
	...
	write(200,*)
	write(200,*) "SOC VB (meV)",abs(vbmsoc*1000)
	write(200,*) "SOC CB (meV)",abs(cbmsoc*1000)
	write(200,*)
